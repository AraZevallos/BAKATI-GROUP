...
const { getAllProducts, getProductById, createProduct, updateProduct, deleteProduct, getCountProducts, getFeaturedProducts, storage, updateProductGallery } = require('../controllers/controller-product')
